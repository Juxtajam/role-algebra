...
Target model (approved fallback; Llama-3.3 token lacks scopes):
  ...
  revision 031d4042f36adc1a52cca51b331d25cbe3cf1022, bf16, ungated,
...
Outputs: phase10/trackA/tokeniser_check.json (+ exit 2 if exemption fires).
"""
...
TARGET_REVISION = "031d4042f36adc1a52cca51b331d25cbe3cf1022"
GEN_MODEL = "Qwen/Qwen3-32B"
TASKS = ROOT / "results/verdict/gate/tasks"
TOKDIR = ROOT / "phase10/trackA/tokenizer_files"  # rev-pinned direct fetch
OUT = ROOT / "phase10/trackA/tokeniser_check.json"
